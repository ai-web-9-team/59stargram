...
def home():
    ...
    try:
        ...
        data = db.Profile.files.find_one({'filename': user_id})
        my_id = data['_id']
        ...
        #
        return render_template('index.html', info=user_info, feeds_info=feeds_info, recommend_info=recommend_info, profile_image=data)
